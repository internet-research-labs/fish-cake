...
/***/ (function(module, exports, __webpack_require__) {
	...
	function lezgo(id) {
	  ...
	  var _app$eventHandlers = app.eventHandlers(),
	      keypress = _app$eventHandlers.keypress;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _functionUtils = __webpack_require__(4);
	  ...
	  _createClass(PlanetApp, [{
	    ...
	    value: function eventHandlers() {
	      ...
	      return {
	        ...
	        keydown: {},
	        resize: (0, _functionUtils.debounce)(100, function (ev) {
	          var size = Math.min(window.innerWidth, window.innerHeight);
	          _this.width = window.innerWidth;
	          _this.height = window.innerHeight;
	          self.resize(_this.width, _this.height);
	        }),
	        move: (0, _functionUtils.debounce)(10, function (ev) {
	          mouse.x = ev.clientX;
	          mouse.y = ev.clientY;
	    ...
	    value: function updateWorld(world) {
	      ...
	      world.buildings.forEach(function (v) {
	        ...
	        var p = _this2.coord(theta, fi, 1.0);
	        var q = _this2.coord(theta, fi, 6.0);
	        var r = _this2.coord(theta + 0.1, fi, 1.0);
	        var b = (0, _math.sub)(q, p);
	        var c = (0, _math.sub)(r, p);

	        var f = new THREE.Vector3(c[0], c[1], c[2]);
	        f.normalize();

	        var o = new THREE.Mesh(
	        // new THREE.ConeGeometry(0.25, height),
	        new THREE.BoxGeometry(0.3, height, 0.3), material);
	    ...
	    value: function update(params) {
	      ...
	      if (this.targetShip && this.ships.has(this.targetShip)) {
	        var _ships$get = this.ships.get(this.targetShip),
	            coord = _ships$get.coord;

	        var theta = coord.theta,
	            fi = coord.fi;

	        var _coord3 = this.coord(theta, fi),
	            _coord4 = _slicedToArray(_coord3, 3),
	            x = _coord4[0],
	            y = _coord4[1],
	            z = _coord4[2];

	        var _coord5 = this.coord(theta, fi, 40.0),
	            _coord6 = _slicedToArray(_coord5, 3),
	            a = _coord6[0],
	            b = _coord6[1],
	            c = _coord6[2];

	        var _sub = (0, _math.sub)(this.coord(theta, fi + 0.01, 40.0), this.coord(theta, fi - 0.01, 40.0)),
	            _sub2 = _slicedToArray(_sub, 3),
	            p = _sub2[0],
	            q = _sub2[1],
	            r = _sub2[2];
	        ...
	        var t = new Date() / 50000.0;
	        var _r = 40.0;

	        var _x = _r * Math.cos(t);
	        var _y = 0.0;
	        var _z = _r * Math.sin(t);
